        ...
        value: function sendotp() {
          ...
          if (username.length == 0) {
            ...
            this.http.post('https://mywash.herokuapp.com/registerotp', data).subscribe(function (result) {
              ...
              if (result.message == '2') {
                _this.storage.set('email', _this.email).then(function (successData) {
                  console.log('email stored');
                });

                _this.router.navigateByUrl('/registernew');
              } else if (result.message == '1') {
                _this.doAlert('Phonenumber Already Registered!', 'Okay');

                _this.phonenumber = '';
              } else if (result.message == '0') {
                _this.doAlert('Email Already Registered!', 'Okay');
