(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function $$_lazy_route_resourceLazyRecursive(module, exports, __webpack_require__) {
    var map = {
      ...
      "./pickloc/pickloc.module": ["./src/app/pickloc/pickloc.module.ts", "pickloc-pickloc-module"],
      "./policy/policy.module": ["./src/app/policy/policy.module.ts", "policy-policy-module"],
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    const routes = [{
      ...
      path: 'registernew',
      loadChildren: './registernew/registernew.module#RegisternewPageModule'
    }, {
      path: 'tabs',
