      ...
      _createClass(DashmodPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.storage.get('email').then(function (data) {
            ...
            _this.req = {
              email: _this.email,
              vehicleCatagory: _this.cat
            };
          }).then(function () {
            console.log(_this.req);

            _this.http.post('https://mywash.herokuapp.com/service/find', _this.req).subscribe(function (result) {
        ...
        value: function dismiss() {
          ...
          if (prod.vehnumber == undefined) {
            ...
            this.crt = this.crt.filter(function (item) {
              return item.number != _this3.selection;
            });
            console.log(this.crt);
