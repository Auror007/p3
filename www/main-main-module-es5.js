...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main-main-module"], {
  ...
  function srcAppMainMainPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MainPage = /*#__PURE__*/function () {
      function MainPage(router, splash) {
        _classCallCheck(this, MainPage);

        this.router = router;
        this.splash = splash;
        this.splash.show(); //this.splash.hide();
      }
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_3__["SplashScreen"]])], MainPage);
    /***/
  }
}]);
