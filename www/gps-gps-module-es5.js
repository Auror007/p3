...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["gps-gps-module"], {
  ...
  function srcAppGpsGpsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var GpsPage = /*#__PURE__*/function () {
      function GpsPage(afAuth, afs, http, storage) {
      ...
      _createClass(GpsPage, [{
        ...
        value: function ionViewWillEnter() {
          ...
          this.storage.get('email').then(function (res) {
            ...
            _this.http.post('https://mywash.herokuapp.com/batch/track', {
              email: _this.email
            }).subscribe(function (res) {
              console.log(res);

              if (res.data != null) {
                _this.user = res.data.cleaner_name;
                _this.phone = res.data.cleaner_phone;
              } else {
                console.log('null');
              }
            });
        ...
        value: function findloc() {
          ...
          this.locations.subscribe(function (locations) {
            ...
            setTimeout(function () {
              ...
              _this3.markers.map(function (marker) {
                return marker.setMap(null);
              });

              _this3.markers = []; // for (let loc of locations) {

              var latLng = new google.maps.LatLng(locations[0].lat, locations[0].lng);

              _this3.map.setCenter(latLng);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_auth__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuth"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_5__["AngularFirestore"], _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClient"], _ionic_storage__WEBPACK_IMPORTED_MODULE_7__["Storage"]])], GpsPage);
    /***/
  }
}]);
