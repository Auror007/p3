      ...
      _createClass(GpsPage, [{
        ...
        value: function anonLogin() {
          ...
          this.afAuth.auth.signInAnonymously().then(function (user) {
            console.log(user);
            _this2.user = user;
            _this2.locationsCollection = _this2.afs.collection("locations/".concat(_this2.user.id, "/track"), function (ref) {
              return ref.orderBy('timestamp');
            });
            _this2.locations = _this2.locationsCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (actions) {
            ...
            _this2.locations.subscribe(function (locations) {
        ...
        value: function startTracking() {
          ...
          this.watch = Geolocation.watchPosition({}, function (position, err) {
            if (position) {
              _this3.addNewLocation(position.coords.latitude, position.coords.longitude, position.timestamp);
            }
          });
        ...
        value: function stopTracking() {
          ...
          Geolocation.clearWatch({
            ...
            _this4.isTracking = false;
          });
        } // Save a new location to Firebase and center the map

      }, {
        key: "addNewLocation",
        value: function addNewLocation(lat, lng, timestamp) {
